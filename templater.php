...
* Template Class
*
* Hoping to develop my own templating engine, just a simple one
* this is the work in progress.

* Hoping to have functionality of:
*
*  - Assinging a 'tagged' foreach loop in the view
*  - Having conditional statements
*  - Just rendering general tags
*/
...
class Templater {
	...
	{
		$this->_main_content = file_get_contents ( 'Views/' . $template . '.php' );
	...
	private function set_tags ( $tags )
	{
		...
		{	
			foreach ( $tags as $tag )
			{
				$replace = $this->_template_tags[ $tag ];
	...
	//////////////////////////////////////////////////////////////////////////////
	// This is obviously just for test purposes
	// Calling the class within the class file to save time moving about everywhere
	// for the minute
	//
	$tmp = new Templater;
	...
	$tags['results'] = $array;
	$tags['NAME'] = 'EVERYWHERE I GO I GOT CHEESE!';
	
	$tmp->set_content ( 'page', $tags );
